		...
		<div class="min-h-screen bg-background p-8" data-testid="options-container">
			<div class="max-w-2xl mx-auto">
				...
				<div class="bg-card p-6 rounded-lg border border-border space-y-6">
					...
					<div class="space-y-2" data-testid="browser-info">
						<label class="block text-sm font-medium text-foreground">
							Browser Info
						</label>
						<p class="text-sm text-foreground">
							Running in: {browserName()}
						</p>
					</div>
			...
			<p class="text-xs text-muted-foreground mt-4 w-full text-center" data-testid="extension-version">
				Version: {version}
			</p>
		</div>
	);
