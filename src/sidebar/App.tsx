...
export const App: Component = () => {
	...
	return (
		<div class="min-h-screen w-full p-6 bg-background">
			<div class="flex flex-col space-y-4">
				...
				<div class="px-3 py-1 bg-secondary rounded-md text-xs text-secondary-foreground inline-block w-fit">
					Theme: {currentTheme()}
				</div>
				...
				<div class="mt-4 p-4 bg-card border border-border rounded-lg">
					<p class="text-sm text-muted-foreground">
						Sidebar mode provides a full-height panel for extended
